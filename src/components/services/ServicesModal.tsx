  ...
  return (
    <>
      ...
      <m.div
        ...
        className="top-0 right-0 fixed h-screen tablet:h-full w-1/2 tablet:w-2/3 sm:w-screen p-5 flex flex-col bg-black z-9999 rounded-xl border border-grey-600"
      >
